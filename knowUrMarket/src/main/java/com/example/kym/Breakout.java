...
public class Breakout extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(s.contentEquals("E"))
			setContentView(R.layout.breakout);
		else if(s.contentEquals("H"))
		{
			setContentView(R.layout.breakouth);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.breakoutb);
		}
		ImageView iv=(ImageView)findViewById(R.id.iv4);
		iv.setImageResource(R.drawable.bol2);
		getSupportActionBar().setTitle("Bollinger Band Breakout");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Breakout.class);
			startActivity(j);
		}
	}
