...
public class Put2 extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(s.contentEquals("E"))
			setContentView(R.layout.put2);
		else if(s.contentEquals("H"))
		{
			setContentView(R.layout.put2h);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.put2b);
		}
		getSupportActionBar().setTitle("Put Options-Profit,Loss & Breakeven");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Put2.class);
			startActivity(j);
		}
	}
}
