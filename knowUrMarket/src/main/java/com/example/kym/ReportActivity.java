...
public class ReportActivity extends ActionBarActivity implements OnItemClickListener, android.view.View.OnClickListener, Runnable
{
	ProgressBar pbR;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		wbReport=(WebView)findViewById(R.id.webViewReport);
		wbReport.getSettings().setJavaScriptEnabled(true);
		wbReport.loadUrl("file:///android_asset/report.html");
		wbReport.setBackgroundColor(0);
        wbReport.setBackgroundResource(R.drawable.finalbck);
	...
	pbR=(ProgressBar)findViewById(R.id.progressBarR);
