...
public class Bear extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			setContentView(R.layout.bearh);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.bearb);
		}
		getSupportActionBar().setTitle("Bearish Engulfing Pattern");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Bear.class);
			startActivity(j);
		}
	}
}
