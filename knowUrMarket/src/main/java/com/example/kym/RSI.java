...
public class RSI extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(s.contentEquals("E"))
			setContentView(R.layout.rsi);
		else if(s.contentEquals("H"))
		{
			setContentView(R.layout.rsih);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.rsib);
		}

		getSupportActionBar().setTitle("Relative Strength Index");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), RSI.class);
			startActivity(j);
		}
	}
}
