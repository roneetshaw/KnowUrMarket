...
public class Class2 extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			setContentView(R.layout.call2h);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.call2b);
		}
		getSupportActionBar().setTitle("Call Options-Profit,Loss & Breakeven");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Class2.class);
			startActivity(j);
		}
	}
}
