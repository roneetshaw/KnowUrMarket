...
public class BCS extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			setContentView(R.layout.bcsh);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.bcsb);
		}
		getSupportActionBar().setTitle("Bull Call Spread");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), BCS.class);
			startActivity(j);
		}
	}
}
