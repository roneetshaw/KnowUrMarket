...
public class CurrenyActivity extends ActionBarActivity implements OnItemClickListener, android.view.View.OnClickListener,Runnable
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		wbC=(WebView)findViewById(R.id.webViewCurrency);
		wbC.getSettings().setJavaScriptEnabled(true);
		wbC.getSettings().setSupportZoom(true);       //Zoom Control on web (You don't need this
        //if ROM supports Multi-Touch     
		wbC.getSettings().setBuiltInZoomControls(true);
		wbC.loadUrl("file:///android_asset/currency.html");
		wbC.setBackgroundColor(0);
        wbC.setBackgroundResource(R.drawable.finalbck);
		pbC=(ProgressBar)findViewById(R.id.progressBarC);
