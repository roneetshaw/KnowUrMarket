...
public class ROC extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(s.contentEquals("E"))
			setContentView(R.layout.roc);
		else if(s.contentEquals("H"))
		{
			setContentView(R.layout.roch);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.rocb);
		}

		getSupportActionBar().setTitle("Rate of Change(ROC)");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), ROC.class);
			startActivity(j);
		}
	}
}
