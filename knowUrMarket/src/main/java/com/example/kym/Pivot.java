...
public class Pivot extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			setContentView(R.layout.pivoth);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.pivotb);
		}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Pivot.class);
			startActivity(j);
		}
	}
}
