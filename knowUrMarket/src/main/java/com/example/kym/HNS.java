...
public class HNS extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(s.contentEquals("E"))
			setContentView(R.layout.hns);
		else if(s.contentEquals("H"))
		{
			setContentView(R.layout.hnsh);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.hnsb);
		}
		getSupportActionBar().setTitle("Head & Shoulders");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), HNS.class);
			startActivity(j);
		}
	}
}
