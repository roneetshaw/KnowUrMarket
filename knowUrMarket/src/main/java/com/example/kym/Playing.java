...
public class Playing extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			setContentView(R.layout.playingh);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.playingb);
		}
		ImageView iv=(ImageView)findViewById(R.id.iv3);
		iv.setImageResource(R.drawable.bol1);
		getSupportActionBar().setTitle("Playing the Bands");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Playing.class);
			startActivity(j);
		}
	}
}
