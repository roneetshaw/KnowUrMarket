...
public class Doji extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(s.contentEquals("E"))
			setContentView(R.layout.doji);
		else if(s.contentEquals("H"))
		{
			setContentView(R.layout.dojih);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.dojib);
		}
		getSupportActionBar().setTitle("Doji");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Doji.class);
			startActivity(j);
		}
	}
}
