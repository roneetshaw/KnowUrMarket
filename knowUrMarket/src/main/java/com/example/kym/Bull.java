...
public class Bull extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(s.contentEquals("E"))
			setContentView(R.layout.bull);
		else if(s.contentEquals("H"))
		{
			setContentView(R.layout.bullh);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.bullb);
		}
		getSupportActionBar().setTitle("Bullish Engulfing Pattern");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Bull.class);
			startActivity(j);
		}
	}
}
