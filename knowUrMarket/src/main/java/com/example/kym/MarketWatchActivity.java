...
public class MarketWatchActivity extends ActionBarActivity implements OnItemClickListener, android.view.View.OnClickListener, Runnable
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		wbmarket=(WebView)findViewById(R.id.webViewMarket);
		wbmarket.getSettings().setJavaScriptEnabled(true);
		wbmarket.loadUrl("file:///android_asset/marketwat.html");
		wbmarket.setBackgroundColor(0);
        wbmarket.setBackgroundResource(R.drawable.finalbck);
	...
	pbMW=(ProgressBar)findViewById(R.id.progressBarMW);
	new Thread(this).start();
	pbMW.setVisibility(View.VISIBLE);
	}	
	@Override
	public void run()
	{
		...
		{
			Thread.sleep(3000);
			pbMW.setVisibility(View.INVISIBLE);
		}
