...
public class Windows extends ActionBarActivity{
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Windows.class);
			startActivity(j);
		}
	}
}