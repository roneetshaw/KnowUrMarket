...
public class Vix extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(s.contentEquals("E"))
			setContentView(R.layout.vix);
		else if(s.contentEquals("H"))
		{
			setContentView(R.layout.vixh);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.vixb);
		}

		getSupportActionBar().setTitle("Volume Index(VIX)");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Vix.class);
			startActivity(j);
		}
	}
}
