...
public class Basics extends ActionBarActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		{
			setContentView(R.layout.basicsh);
		}
		else if(s.contentEquals("B"))
		{
			setContentView(R.layout.basicsb);
		}
		getSupportActionBar().setTitle("Candlestick Basics");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		{
			Intent j=new Intent(getApplicationContext(), Basics.class);
			startActivity(j);
		}
	}
}